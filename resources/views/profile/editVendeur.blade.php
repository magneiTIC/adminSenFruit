...
@extends('layouts.vendeur', ['activePage' => 'profile', 'titlePage' => __('Profil vendeur')])
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('telephone') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('telephone') ? ' is-invalid' : '' }}" name="telephone" id="input-telephone" type="telephone" placeholder="{{ __('telephone') }}" value="{{ old('telephone', auth()->user()->email) }}" required />
